...
export const Projects = () => {
  ...
  const projects = [
    ...
    {id: 0, title: 'Сайт-карточка', text: 'Симулятор онлайн карточки', url: 'https://backiev.github.io/card/', img: './images/card.png'},
    {id: 1, title: 'Верстка сайта', text: 'Адаптивная верстка сайта', url: 'https://backiev.github.io/zendit/dist/', img: './images/single.png'},
  ]
